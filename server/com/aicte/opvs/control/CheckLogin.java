...
//		response.getWriter().append("Served at: ").append(request.getContextPath());
		...
		if (session == null) {
			replyJSON = JSONReply.generateReplyJSON(0, "ERROR", new JSONArray(), "No Session Found");
		}
		else {
			replyJSON = JSONReply.generateReplyJSON(1, "SUCCESS", new JSONArray(), "Session Found");
		}
